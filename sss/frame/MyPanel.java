...
public class MyPanel extends JPanel implements MouseListener {
    ...
    ArrayList<FlyObject> enemys=new ArrayList<FlyObject>();//敌人

    ArrayList<FlyObject> bullets=new ArrayList<FlyObject>();//子弹

    ArrayList<FlyObject> rewards=new ArrayList<FlyObject>();//奖励
    ...
    public void addBullet(int speed){//添加子弹
